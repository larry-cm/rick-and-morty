...
export function Persons() {
    return (
        <svg viewBox="0 0 16 16" fill="none" class="min-w-4 max-w-5 dark:text-white text-slate-200" stroke="white"
        ><path
...
export function Temporadas() {
    return (
        <svg
            ...
            viewBox="0 0 48 48"
            class="min-w-4 w-5 dark:text-white text-slate-200"
        >
...
export function Ubicaciones() {
    return (
        <svg
            ...
            stroke-width="2"
            class="min-w-4 max-w-5 dark:text-white text-slate-200"
        >
            <path
